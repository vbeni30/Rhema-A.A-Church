        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <p className="text-lg text-gray-700 mb-6">
              At Gospel Church, our beliefs are rooted in the timeless truths of the Bible. We hold to the fundamental
            ...
            <Button className="bg-[#9B2B3A] text-white hover:bg-[#8a2533]">Read Our Full Statement of Faith</Button>
          </div>
            ...
            <ul className="space-y-4">
              {beliefs.map((belief, index) => (
                <li key={index} className="flex items-start">
                  <Check className="h-6 w-6 text-[#9B2B3A] mr-2 mt-1 flex-shrink-0" />
